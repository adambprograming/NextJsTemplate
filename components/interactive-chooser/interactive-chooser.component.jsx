...
function setInitialValuesToSessionStorage(option) {
  ...
  switch (option) {
    case "web1":
      initialValues = {
        scope: "1 stránka, jednoduché, rychlé, optimalizované",
        functions: "Responzivní, vlastní doména, hosting",
        // price: "~ 10.000 CZK",
      };
      break;
    case "web2":
      initialValues = {
        scope: "1-5 stránek, komplexní, rychlé, optimalizované",
        functions: "Responzivní, vlastní doména, hosting, denní a noční režim",
        // price: "~ 25.000 CZK",
      };
      break;
    case "web3":
      initialValues = {
        scope: "5+ stránek, profesionální, rychlé, optimalizované",
        functions:
          "Responzivní, vlastní doména, hosting, denní a noční režim, vícejazyčnost, systém úpravy obsahu",
        // price: "~ 45.000 CZK",
      };
      break;
    case "eshop1":
      initialValues = {
        scope: "5+ stránek, profesionální, rychlé, optimalizované",
        functions:
          "Responzivní, vlastní doména, hosting, denní a noční režim, vícejazyčnost, systém úpravy obsahu, správa objednávek",
        // price: "~ 75.000 CZK",
      };
      break;
    case "eshop2":
      initialValues = {
        scope:
          "5+ stránek, profesionální, rychlé, optimalizované, platební brána",
        functions:
          "Responzivní, vlastní doména, hosting, denní a noční režim, vícejazyčnost, systém úpravy obsahu, správa objednávek",
        // price: "~ 100.000 CZK",
      };
    ...
    case "eshop3":
      initialValues = {
        scope:
          "5+ stránek, profesionální, rychlé, optimalizované, platební brána, databáze produktů, uživatelské rozhraní",
        functions:
          "Responzivní, vlastní doména, hosting, denní a noční režim, vícejazyčnost, systém úpravy obsahu, správa objednávek",
        // price: "~ 150.000 CZK",
      };
    ...
    case "webapp":
      initialValues = {
        scope: "Webová aplikace s následující strukturou:",
        functions: "Potřebuji následující funkce:",
      };
      break;
    default:
      break;
        ...
        <div className={`${styles.cardContainer} ${styles.firstCardContainer}`}>
          ...
          >
            <div className={`${styles.titleContainer}`}>
              ...
              <h1>
                O jaké <strong>služby</strong> máte zájem?
              </h1>
              <hr />
            </div>
            <div
                    ...
                    >
                      ...
                      <div className={`${styles.descriptionContainer}`}>
                        ...
                        <div>
                          ...
                          <p>
                            Vlastní řešení pro malé podnikatele bez zbytečných
                            poplatků
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div className={`${styles.descriptionContainer}`}>
                        ...
                        <div>
                          ...
                          <p>Spolupráce na vytváření webových softwarů</p>
                        </div>
                      </div>
                    </Btn>
                  </CarouselItem>
            ...
            {firstCardPick === 1 ? (
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>WEBY</span>
                  <h1>
                    O jaké <strong>webové</strong> stránky máte zájem?
                  </h1>
                  <hr />
                </div>
                <div
                ...
                <div className={`${styles.infoContainer}`}>
                  <div>
                    ...
                    <p>
                      Rozdělení je pouze orientační, vždy se můžeme domluvit na
                  ...
                  <div>
                    ...
                    <p>
                      V případě, že již máte webové stránky, můžeme společně
                      domluvit lepší podmínky pro vedení stránek, nebo je
                      zmodernizovat.
                    </p>
                  </div>
                </div>
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>E-SHOPY</span>
                  <h1>
                    Jaký typ <strong>podnikání</strong> vlastníte?
                  </h1>
                  <hr />
                </div>
                <div
                  ...
                  {widthOfWindow < 880 ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className={`${styles.descriptionContainer}`}>
                          <span className={`${styles.btnTitle}`}>Jedinec</span>
                          <div>
                            <span>
                              <IconCheckCircle
                                style={{ color: "var(--color-success)" }}
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>VÝVOJ</span>
                  <h1>
                    Webová aplikace <strong>na míru</strong>
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      V případě, že potřebujete specifickou webovou aplikaci,
                      nebo máte nápad a potřebujete pomoc s jeho realizací v
                      podobě webové aplikace, neváhejte mě kontaktovat. V
                      následujících bodech jsou příklady kategorií webových
                      aplikací.
                    </p>
                  </div>
                  ...
                  {/* <div className={`${styles.infoContainer}`}>
                    <div><span><IconInfoCircle style={{fill: "var(--shadow-25)"}}/></span><p>Cena zde nejde přesně určit, odvíjí se primárně od složitosti a velikosti webové aplikace, standartně je počítána podle hodin strávených na projektu.</p></div>
                  </div> */}
                </div>
              </>
            )}
            ...
            {firstCardPick === 1 && secondCardPick === 1 ? (
              <>
                <div className={`${styles.titleContainer}`}>
                  ...
                  <h1>
                    <strong>Jednoduché</strong> webové stránky
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      Jednoduché webové stránky jsou ideální pro jednotlivce
                      nebo malé firmy, které potřebují online prezentaci s
                      minimálním obsahem. Tato varianta nabízí jednu stránku s
                  ...
                  <div className={`${styles.checkboxDescription}`}>
                    ...
                    <div>
                      ...
                      <p>
                        Možnost rozšíření - denní a noční režim, vícejazyčnost a
                        Systém úpravy obsahu
                      </p>
                    </div>
                  </div>
                  <div className={`${styles.ctaBtns}`}>
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>PREZENTACE</span>
                  <h1>
                    <strong>Komplexní</strong> webové stránky
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      Komplexní webové stránky jsou vhodné pro firmy, které
                      potřebují více obsahu a rychlou navigaci mezi 1-5
                      stránkami. Tento typ webu zahrnuje také změnu režimu mezi
                  ...
                  <div className={`${styles.checkboxDescription}`}>
                    ...
                    <div>
                      ...
                      <p>
                        Možnost rozšíření - vícejazyčnost a Systém úpravy obsahu
                      </p>
                    </div>
                  </div>
                  <div className={`${styles.ctaBtns}`}>
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>PREZENTACE</span>
                  <h1>
                    <strong>Profesionální</strong> webové stránky
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      Profesionální webové stránky jsou ideální pro firmy, které
                      potřebují rozsáhlý a interaktivní web s více než 5
                      stránkami. Tento typ webu zahrnuje Systém úpravy obsahu,
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>PRODEJ</span>
                  <h1>
                    E-shop pro <strong>jedince</strong>
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      E-shop je ideální pro jedince, kteří chtějí začít prodávat
                      své produkty online, ale nechtějí platit poplatky platební
                      bráně. V případě, že si produkty vyrábíte a chcete svým
                      zákazníkům umožnit jejich koupi za co nejnižší cenu, je
                      tento typ e-shopu přesně pro Vás.
                    </p>
                  </div>
                  <div className={`${styles.checkboxDescription}`}>
                    <div>
                    ...
                    <div>
                      ...
                      <p>
                        Možnost rozšíření - denní a noční režim, vícejazyčnost,
                        databáze produktů a uživatelské rozhraní
                      </p>
                    </div>
                  </div>
                  <div className={`${styles.ctaBtns}`}>
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>PRODEJ</span>
                  <h1>
                    E-shop pro <strong>maloobchod</strong>
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      E-Shop pro maloobchod je navržen pro firmy, které
                      potřebují robustní online prodejní platformu a mají více
                      produktů. Tento typ e-shopu zahrnuje napojení na platební
                      bránu, což oceníte v případě většího počtu zákazníků.
                    </p>
                  </div>
                  <div className={`${styles.checkboxDescription}`}>
                    <div>
                    ...
                    <div>
                      ...
                      <p>
                        Možnost rozšíření - databáze produktů a uživatelské
                        rozhraní
                      </p>
                    </div>
                  </div>
              ...
              <>
                <div className={`${styles.titleContainer}`}>
                  <span>PRODEJ</span>
                  <h1>
                    E-shop pro <strong>velkoobchod</strong>
                  </h1>
                  <hr />
                </div>
                <div className={`${styles.contentContainer}`}>
                  <div className={`${styles.categoryDescription}`}>
                    <p>
                      E-Shop pro velkoobchod je určen pro společnosti, které
                      potřebují komplexní a rozsáhlé e-shopové řešení s vlastním
                      rozhraním pro uživatele a přístupem do vlastní databáze
                      produktů. Tento typ e-shopu podporuje velké množství
                      produktů.
                    </p>
                  </div>
                  <div className={`${styles.checkboxDescription}`}>
